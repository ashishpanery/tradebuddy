...
import './Services.css'
import image from '../images/consult-image.png'
    ...
    return (
        <>
            ...
            <div className='services'>
                <div className='services-top yellowBg'>
                    <img src={image} alt='' />
                </div>
                    ...
                    <div className='services-list'>
                        <div className='service-list-column'>
                            <div className='service-list-cards'>
                                <div className='service-list-cards-image yellowBg'>
                                    <img src={puzzle} alt='' />
                                </div>
                ...
                <div className='services-container'>
                    ...
                    <div className='service-session-rows'>
                        <div className='service-sessions'>
                            ...
                            <div className='service-session-details yellowBg'>
                                <h2>Resume Review</h2>
                ...
                <div className='services-container'>
                    ...
                    <div className='service-steps-row'>
                        <div className='service-steps yellowBg'>
                ...
                <div className='faqSection yellowBg'>
                    <h1><span>F</span>&Q</h1>
