        ...
        <main className=" d-flex flex-column justify-content-start align-items-center event_Success mt-5 pt-5">
            {
                msg === "edit_success" ?
                    ...
                    :
                    <h1 className="text-success mt-5 fs-1 px-4 text-center px-lg-0">Event has been successfully created.</h1>
            }
            <button className="mt-3 btn" onClick={() => history.push('/my-events')}>Go back</button>
        </main>
        <Footer />
    </>
}
